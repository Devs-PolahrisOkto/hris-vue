  ...
  <main-layout>
    ...
    <nav class="breadcrumb px-5" aria-label="breadcrumbs">
      <ul class="px-3 pt-3">
        ...
        <li class="is-active"><a href="#" aria-current="page">Overtime</a></li>
      </ul>
    </nav>
    <!-- End Breadcrumb -->
    <!-- Overtime Table -->
      ...
      <div class="card p-2">
        <header class="is-flex is-justify-content-space-between is-align-items-center py-2 px-3">
          <h6 class="has-text-weight-medium is-flex is-align-items-center">
            ...
            <h6 class="is-size-6 has-text-weight-semibold px-3">Overtime Requests</h6>
          </h6>
          <div>
            <b-tooltip label="Add">
              <b-button
...
export default {
  components: {
    ...
    AddModal: () => import('@/components/Timekeeping/Overtime/AddModal.vue'),
  },
